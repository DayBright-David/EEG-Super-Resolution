...
def get_args():
    ...
    parser.add_argument('--fold_num', default=6, type=int,
                        help='number of fold')
...
def main(args):
    ...
    for fold_idx in range(args.fold_num):
        ...
        dataset_train, dataset_test = build_Benchmark_dataset_for_finetune(root_dir=args.dataset_root_dir, winLEN=args.input_size/args.srate, sub=args.sub, test_block_idx=fold_idx)
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            if args.output_dir:
                utils.save_finetune_model(sub=args.sub, test_block_idx=fold_idx,
