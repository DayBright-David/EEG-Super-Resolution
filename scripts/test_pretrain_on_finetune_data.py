...
def get_args():
    ...
    # checkpoint
    parser.add_argument('--start_epoch', default=499, type=int)
    parser.add_argument('--epochs', default=1999, type=int)
    parser.add_argument('--epoch_interval', default=500, type=int)
...
def main(args):
    ...
    dataset_train, dataset_test = build_Benchmark_dataset_for_finetune(root_dir=args.dataset_root_dir, winLEN=args.input_size/args.srate, sub=args.sub, test_block_idx=0)
